//Program Description
//Name: interpolation_search.java
//Author: Chris Yang
//Language: Java
...
public class interpolation_search {
    ...
    public static int inter_search(int data[], int value) {
        int low, mid, high;
        low = 0;
        high = 99;
        int temp;
        ...
        while (low <= high && -1 != value) {
            temp = (int)((float)(value - data[low]) / (data[high] - data[low]) * (high - low));
            mid = low + temp;
            if (mid >= 50 || mid <= -1) {
                return -1;
            }
